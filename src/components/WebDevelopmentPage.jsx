...
import { Phone, Mail, MapPin, ArrowRight, CheckCircle, Globe, Users, Zap, Shield, TrendingUp, ArrowLeft, Code2 } from 'lucide-react'
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
              WEB DEVELOPMENT SOLUTIONS IN NIGERIA | ITECHLINK SOLUTIONS
            </h1>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Modern Web Development That Drives Results
            </h2>
            <p className="text-xl text-gray-600 leading-relaxed">
              Your website is often the first impression customers have of your business. At iTech Link, we design and develop modern, responsive, and result-driven websites that don't just look good—they work hard to achieve your business goals.
            </p>
          </motion.div>
            ...
            <div className="grid md:grid-cols-5 gap-8">
              {[
                ...
                },
                {
                  ...
                  desc: 'Clean, professional, and mobile-friendly layouts.',
                  icon: Globe,
                  color: 'green'
                },
                {
                  title: 'Development',
                  desc: 'Fast, secure, and functional websites built for performance.',
                  icon: Code2,
                  color: 'purple'
                },
                {
                  title: 'Testing & Launch',
                  desc: 'Ensuring your site works smoothly across all devices.',
                  icon: Shield,
                  color: 'orange'
                },
                {
                  title: 'Ongoing Support',
                  desc: 'Regular updates, maintenance, and enhancements.',
                  icon: TrendingUp,
                  color: 'red'
                }
              ].map((item, index) => {
          ...
          >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                'Responsive Websites – Mobile-friendly sites that adapt to any screen size.',
                'E-Commerce Solutions – Online stores that drive sales and create great shopping experiences.',
                'Content Management Systems (CMS) – Easy-to-manage websites that put you in control.',
                'Web Applications – Interactive platforms to engage your customers.',
                'Corporate & Portfolio Websites – Professional online presence for businesses and individuals.'
              ].map((item, index) => (
              ...
              {[
                {
                  ...
                  desc: 'Your website is your digital storefront.',
                  icon: Globe,
                  color: 'blue'
                },
                {
                  title: 'Customer Trust',
                  desc: 'A professional site builds credibility and confidence.',
                  icon: Shield,
                  color: 'green'
                },
                {
                  title: 'Accessibility',
                  desc: 'Be available to customers 24/7, anywhere in the world.',
                  icon: Zap,
                  color: 'purple'
                },
                {
                ...
                {
                  title: 'Scalability',
                  desc: 'Websites designed to grow as your business expands.',
                  icon: TrendingUp,
                  color: 'red'
                }
              ].map((item, index) => {
